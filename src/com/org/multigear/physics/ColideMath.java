...
final public class ColideMath {
	 ...
	 */
	final static protected Vector2 getIntersectionLines(com.org.multigear.general.utils.Line2 a, com.org.multigear.general.utils.Line2 b) {
		// Get Positions
	 ...
	 */
	final static public Vector2 getCenterOfShape(final com.org.multigear.physics.Shape shape) {
		float totalX = 0;
		float totalY = 0;
	 ...
	 */
	final static public com.org.multigear.physics.Shape[] subdivideShapeInCenteredTriangles(final com.org.multigear.physics.Shape shape) {
		final int size = shape.getSize();
		if(size < 3)
			return null;
		final com.org.multigear.physics.Shape[] shapes = new com.org.multigear.physics.Shape[size];
		...
		for(int i=0; i<(size-1); i++) {
			...
			shapes[i] = com.org.multigear.physics.Shape.createShape(trianglePackage);
		}
		// Close Shape
		...
		trianglePackage[1] = verticeB;
		trianglePackage[2] = center;
		shapes[size-1] = com.org.multigear.physics.Shape.createShape(trianglePackage);
		return shapes;
	}
	 ...
	 */
	final static public float getTriangleShapeArea(final com.org.multigear.physics.Shape triangle) {
	 ...
	 */
	final static public boolean isOverTriangleShape(final Vector2 point, final com.org.multigear.physics.Shape triangle) {
	 ...
	 */
	final static public Vector2 getOverShapeNormal(final Vector2 point, final com.org.multigear.physics.Shape shape) {
		final com.org.multigear.physics.Shape[] triangles = subdivideShapeInCenteredTriangles(shape);
		/**
