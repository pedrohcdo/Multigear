...
public class AudioManager implements SoundPool.OnLoadCompleteListener {
	...
	final private com.org.multigear.audio.Cache mCache;
	final private com.org.multigear.audio.PreCache mPreCache;
	...
	private com.org.multigear.audio.Listener mListener;
	private float mLeftVol = 1f, mRightVol = 1f, mRate = 1f;
	
	/*
	 * Construtor
	 */
	public AudioManager(final com.org.multigear.mginterface.engine.Manager manager) {
		mManager = manager;
		mSoundPool = new SoundPool(10, android.media.AudioManager.STREAM_MUSIC, 0);
		mSoundPool.setOnLoadCompleteListener(this);
		mCache = new com.org.multigear.audio.Cache();
		mPreCache = new com.org.multigear.audio.PreCache();
	...
	public void onLoadComplete(SoundPool soundPool, int sampleId, int status) {
		...
		if(preArchive == null){
			com.org.multigear.general.utils.KernelUtils.error(mManager.getEngine().getActivity(), "AudioSupport: An unexpected error occurred loading an audio file.", 0x12);
			return;
		}
	 ...
	 * 
	 */
	final public void setListener(final com.org.multigear.audio.Listener listener) {
		mListener = listener;
	}
