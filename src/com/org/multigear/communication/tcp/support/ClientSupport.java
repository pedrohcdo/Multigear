...
import com.org.multigear.communication.tcp.base.Message;
import com.org.multigear.communication.tcp.base.Utils;
import com.org.multigear.communication.tcp.client.Client;
import com.org.multigear.communication.tcp.client.ServersList;
import com.org.multigear.mginterface.engine.Manager;
...
public class ClientSupport {
	 ...
	 * Property Createlier.
	 */
	final private class BlockedListener implements com.org.multigear.communication.tcp.client.Listener {
		/*
		 * Servers Listed
		 */
		@Override
		public void onListed(ServersList serverList) {
			final com.org.multigear.communication.tcp.support.SupportMessage message = new com.org.multigear.communication.tcp.support.SupportMessage(com.org.multigear.communication.tcp.support.SupportMessage.CLIENT_LISTEDSERVERS, serverList);
		...
		public void onConnected(BaseConnected serverCon) {
			...
			final SupportMessage message = new SupportMessage(com.org.multigear.communication.tcp.support.SupportMessage.CLIENT_CONNECTEDTOSERVER, connectionInfo);
			mComSupport.recvMessageForSupport(message);
		}
		...
		public void onConnectionFailed() {
			...
			mConnecting = false;
			// Send support message
			final SupportMessage message = new SupportMessage(com.org.multigear.communication.tcp.support.SupportMessage.CLIENT_CONNECTFAILED, null);
			mComSupport.recvMessageForSupport(message);
		}
	}
	 ...
	 * Construtor
	 */
	public ClientSupport(final com.org.multigear.communication.tcp.support.ComManager comSupport, final com.org.multigear.mginterface.engine.Manager manager, final String name, final int port) {
		mComSupport = comSupport;
		mClient = new com.org.multigear.communication.tcp.client.Client(manager, name, port);
	...
	final public void listServers(final int range) {
		if(mConnecting)
			com.org.multigear.general.utils.KernelUtils.error(mManager.getEngine().getActivity(), "ClientSupport: An error ocurred while calling 'connect'. The client is already trying to connect.", 0x11);
	 ...
	 * Conecta a um Host
	 */
	final public void connect(final com.org.multigear.communication.tcp.client.ServersList.ServerInfo serverInfo, final int attempts) {
		if(mConnected)
