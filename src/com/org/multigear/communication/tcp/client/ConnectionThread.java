...
final public class ConnectionThread extends Thread {
	...
	final private com.org.multigear.communication.tcp.client.ServersList.ServerInfo mServerInfo;
	 ...
	 * Construtor
	 */
	public ConnectionThread(final com.org.multigear.communication.tcp.client.Client client, final com.org.multigear.communication.tcp.client.ServersList.ServerInfo serverInfo, final int port, final int attempts) {
	...
	public void run() {
		for(int i=0; i<mAttempts; i++) {
			...
			try {
				...
				out.println(com.org.multigear.communication.tcp.base.Utils.makeSocketMessage(com.org.multigear.communication.tcp.base.Utils.CODE_SERVER_WAITCONNECT, mClient.getName()));
