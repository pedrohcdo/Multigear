...
final public class Configuration {
	...
	final public class OptimizedKey {
		...
		final public boolean wasReconfigured() {
			...
			if(mMode == 1 && reconfigured) {
				final com.org.multigear.mginterface.engine.Configuration.Attr attr = getAttr(mName);
				if(mSaveAttr == null) {
	...
	// Private Variables
	private Class<? extends com.org.multigear.mginterface.scene.Scene> mMainRoom;
	private int mFlags;
	...
	public Configuration() {
		mMainRoom = com.org.multigear.mginterface.scene.Scene.class;
		mFlags = 0;
	 ...
	 */
	final public void setMainRoom(final Class<? extends com.org.multigear.mginterface.scene.Scene> mainRoom) {
		if(mEngineCreated)
			com.org.multigear.general.utils.KernelUtils.error(mActivity, ERROR_MESSAGE_ILLEGAL_MOD_MAINROOM, ERROR_CODE_ILLEGAL_MOD_MAINROOM);
		mMainRoom = mainRoom;
	}
