...
import com.org.multigear.mginterface.engine.servicessuport.SupportService;
...
final public class Multigear {
	...
	final private com.org.multigear.mginterface.engine.Configuration mConfiguration;
	final private AtomicBoolean mSyncStarted;
	final private com.org.multigear.mginterface.engine.Surface mSurface;
	final private com.org.multigear.mginterface.engine.Manager mManager;
	final private com.org.multigear.mginterface.engine.eventsmanager.EventHandler mEventHandler;
	 ...
	 * Construtor
	 */
	public Multigear(final Activity activity, final com.org.multigear.mginterface.engine.Configuration configuration) {
		mActivity = activity;
		mConfiguration = configuration;
		mConfiguration.onEngineCreated(activity);
		mSyncStarted = new AtomicBoolean(false);
		mSurface = new com.org.multigear.mginterface.engine.Surface(this);
		mManager = new com.org.multigear.mginterface.engine.Manager(this);
		mEventHandler = new com.org.multigear.mginterface.engine.eventsmanager.EventHandler(mManager);
		mFirstBind = true;
	...
	final protected void setupActivity() {
		...
		if (Build.VERSION.SDK_INT >= 11) {
			...
			android.support.v7.app.ActionBar bar = ((ActionBarActivity) mActivity).getSupportActionBar();
			if(bar != null)
				bar.hide();
		}
	 ...
	 */
	final protected com.org.multigear.mginterface.engine.Manager getManager() {
		return mManager;
	}
	 ...
	 * Retorna a Surface
	 */
	final protected com.org.multigear.mginterface.engine.Surface getSurface() {
		return mSurface;
	}
	 ...
	 */
	final public com.org.multigear.mginterface.engine.MultigearSafe safe() {
		// Safe Engine
		return new com.org.multigear.mginterface.engine.MultigearSafe(this, mEventHandler);
	}
