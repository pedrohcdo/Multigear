...
public class Surface {
	...
	// Private Variables
	private com.org.multigear.mginterface.engine.Multigear mEngine;
	private GLSurfaceView mGLSurfaceView;
	private com.org.multigear.mginterface.graphics.opengl.Renderer mRenderer;
	...
	public Surface(final Multigear engine) {
		...
		// Create Renderer
		mRenderer = new com.org.multigear.mginterface.graphics.opengl.Renderer(engine);
