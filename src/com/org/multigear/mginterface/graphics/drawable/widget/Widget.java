package com.org.multigear.mginterface.graphics.drawable.widget;
...
import com.org.multigear.general.utils.Line2;
...
public class Widget implements Drawable, Touchable, Component {
	...
	final public class Skin {
		...
		final private class SkinValue {
			...
			final private com.org.multigear.mginterface.graphics.opengl.texture.Texture Texture;
			
			/*
			 * Construtor
			 */
			public SkinValue(final int id, final com.org.multigear.mginterface.graphics.opengl.texture.Texture texture) {
				ID = id;
				Texture = texture;
			}
		}
		 ...
		 */
		final public void setTexture(final int id, final com.org.multigear.mginterface.graphics.opengl.texture.Texture texture) {
	 ...
	 *            Used Listener.
	 */
	final public void setListener(final com.org.multigear.mginterface.scene.listeners.BaseListener listener) {
		mListener = listener;
	}
	 ...
	 *         {@link com.org.multigear.mginterface.graphics.animations.AnimationStack}
	 */
	...
	final protected float getBaseScaleFacor(Scene scene) {
		if (!scene.hasFunc(com.org.multigear.mginterface.scene.Scene.FUNC_VIRTUAL_DPI))
			return 1f;
