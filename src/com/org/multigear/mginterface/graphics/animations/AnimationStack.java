...
public class AnimationStack {
	...
	final private class Handler {
		...
		final private com.org.multigear.mginterface.graphics.animations.Animation mAnimation;
		 ...
		 * @param code
		 */
		private Handler(final int code, final com.org.multigear.mginterface.graphics.animations.Animation animation) {
			mCode = code;
