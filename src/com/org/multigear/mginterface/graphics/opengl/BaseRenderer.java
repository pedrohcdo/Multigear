...
public abstract class BaseRenderer implements Renderer {
     ...
     * Construtor
     */
    public BaseRenderer(final com.org.multigear.mginterface.engine.Multigear engine) {
    	mEngine = engine;
     ...
     * Retorna a Engine
     */
    final protected com.org.multigear.mginterface.engine.Multigear getEngine() {
    	return mEngine;
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        mScreenSize  = com.org.multigear.general.utils.GeneralUtils.getRealScreenSize(mEngine.getActivity().getWindowManager().getDefaultDisplay(), defaultScreenSize);
        ...
        mDrawer = new Drawer(mEngine.getMainRoom(), (com.org.multigear.mginterface.graphics.opengl.Renderer)this);
