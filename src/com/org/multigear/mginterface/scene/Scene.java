...
import com.org.multigear.mginterface.scene.components.DrawableListener;
import com.org.multigear.mginterface.scene.components.TouchableListener;
...
public class Scene extends com.org.multigear.mginterface.scene.Installation {
	...
	public Scene() {
		...
		mInstallManager = new com.org.multigear.mginterface.scene.InstallManager(this);
	}
	
	/**
	 * Get InstallManager.
	 * 
	 * @return {@link com.org.multigear.mginterface.scene.InstallManager}
	 */
	final com.org.multigear.mginterface.scene.InstallManager getInstallManager() {
	 ...
	 * Altera a engine
	 */
	final public void setEngine(final com.org.multigear.mginterface.engine.Multigear engine) {
		if (mEngine == null) {
			mEngine = engine;
			...
			com.org.multigear.general.utils.KernelUtils.error(mEngine.getActivity(), "Room Class: The method 'setEngine' can only be used by the Engine.", ERROR_PRIVATEMETHOD_CODE);
		}
	}
	...
	final public com.org.multigear.mginterface.engine.Multigear getEngine() {
		if (mEngine == null) {
			com.org.multigear.general.utils.KernelUtils.error(mEngine.getActivity(), "Room Class: A mistake, because this engine null occurred when calling GetEngine ().", ERROR_MISTAKE_CODE);
		}
		return mEngine;
	}
	 ...
	 */
	final public com.org.multigear.mginterface.engine.Configuration getConfiguration() {
	 ...
	 * 
	 * @param angle
	 *            {@link com.org.multigear.general.utils.Vector2} Angle
	 */
	 ...
	 * Get Animation Stack.
	 * 
	 * @return {@link com.org.multigear.mginterface.graphics.animations.AnimationStack}
	 */
	 ...
	 * Get Angle.
	 * 
	 * @return {@link com.org.multigear.general.utils.Vector2} Angle
	 */
	 ...
	 *            Installation
	 */
	final public void install(final com.org.multigear.mginterface.scene.Installation installation) {
	 ...
	 */
	final public void installDelayed(final com.org.multigear.mginterface.scene.Installation installation, final long delay) {
	 ...
	 *            Installation
	 */
	final public void uninstall(final com.org.multigear.mginterface.scene.Installation installation) {
	 ...
	 */
	final public void uninstallDelayed(final com.org.multigear.mginterface.scene.Installation installation, final long delay) {
	...
	final public void calibrateDpiPerCm(final float dpc) {
		final float calibratedDpi = dpc * com.org.multigear.general.utils.GeneralUtils.INCH;
		getConfiguration().setAttr(com.org.multigear.mginterface.engine.Configuration.ATTR_CALIBRATE_DPI, calibratedDpi);
	...
	final public void calibrateDpiPerInch(final float dpi) {
		getConfiguration().setAttr(com.org.multigear.mginterface.engine.Configuration.ATTR_CALIBRATE_DPI, dpi);
		getComManager().sendCalibratedAttributes();
	}
	...
	final public float getDPI() {
		final float calibratedDpi = getConfiguration().getFloatAttr(com.org.multigear.mginterface.engine.Configuration.ATTR_CALIBRATE_DPI);
		if (calibratedDpi != -1)
	 ...
	 */
	final public Vector2 getPhysicalScreenSize(final com.org.multigear.general.utils.Measure measure) {
	...
	@Override
	final public void draw(final com.org.multigear.mginterface.graphics.opengl.drawer.Drawer drawer) {
	 ...
	 * Finalizando desenho
	 */
	final private void endDrawRoom(final com.org.multigear.mginterface.graphics.opengl.drawer.Drawer drawer) {
		// Get Matrix Row
		final WorldMatrix matrixRow = drawer.getWorldMatrix();
		// Pop Matrix
		matrixRow.pop();
	...
	final public boolean hasUninstalling() {
		...
		if (father != null) {
			final com.org.multigear.mginterface.scene.InstallManager installSupport = father.getInstallManager();
	 ...
	 */
	final public com.org.multigear.communication.tcp.support.ComManager getComManager() {
	 ...
	 */
	final public com.org.multigear.audio.AudioManager getAudioManager() {
	 ...
	 *            Database model
	 */
	final public com.org.multigear.database.DataBaseCreator createDatabase(final com.org.multigear.database.DataBaseCreator.Interface impl) {
		return new com.org.multigear.database.DataBaseCreator(getEngine().getActivity(), impl);
	}
	...
	public void onCache(final com.org.multigear.mginterface.graphics.opengl.texture.Loader textureLoader) {
	};
	...
	/* Desenha os objetos */
	public void onDraw(final com.org.multigear.mginterface.graphics.opengl.drawer.Drawer drawer) {
	};
