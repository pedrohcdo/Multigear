...
abstract public class Installation {
	...
	// Private Variables
	private int mZ;
	private com.org.multigear.mginterface.scene.Scene mFatherRoom;
	private Vector2 mScreenSize;
	private com.org.multigear.mginterface.graphics.opengl.texture.Loader mTextureLoader;
	 ...
	 * Set Father
	 */
	final void setFather(final com.org.multigear.mginterface.scene.Scene fatherRoom) {
	 ...
	 * Retorna o Room Pai
	 */
	final public com.org.multigear.mginterface.scene.Scene getFatherRoom() {
		return mFatherRoom;
	}
	 ...
	 * Redimensiona a tela
	 */
	final public void prepareCache(final com.org.multigear.mginterface.graphics.opengl.texture.Loader textureLoader) {
	 ...
	 * @return TextureLoader
	 */
	public com.org.multigear.mginterface.graphics.opengl.texture.Loader getTextureLoader() {
	...
	abstract public void draw(final com.org.multigear.mginterface.graphics.opengl.drawer.Drawer drawer);
